...
output_folder = './resized_images/train512'
images = glob.glob(os.path.join(input_folder, '*.jpg'))
Parallel(n_jobs=12)(
    delayed(resize_image)(
        1,
        output_folder,
        (512, 512)) for i in tqdm(images)
)

# resize test images
input_folder = './input/siim-isic-melanoma-classification/jpeg/ttest/'
output_folder = './resized_images/test512'
images = glob.glob(os.path.join(input_folder, '*.jpg'))
Parallel(n_jobs=12)(
    delayed(resize_image)(
        1,
